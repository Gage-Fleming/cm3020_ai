...
csv_stats_file.write('iteration, fittest, mean, closest_distance_to_mountaintop, average_time_on_mountain, '
                     'smallest_creature_size, largest_creature_size, mean_links, max_links\n')
